...
class weiboAPI(object):         
    ...
    def _initAccessCount(self):
        ...
        logger.info('old acc_count:\t' + self.acc_count)
        ...
        logger.info('new acc_count:\t' + self.acc_count)
        
    def _initAccessLimit(self):
        logger.info('_initAccessLimit')
        logger.info('old acc_limit:\t' + self.acc_limit)
        ...
        logger.info('new acc_limit:\t' + self.acc_limit)
